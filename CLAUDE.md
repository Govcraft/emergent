...
- **acton-reactive**: Published crate (version 8.1.1) with features `ipc` and `ipc-messagepack` — provides the actor framework, IPC, message routing, and lifecycle management
